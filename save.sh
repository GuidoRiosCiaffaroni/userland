...
echo "git remote add origin origin https://github.com/GuidoRiosCiaffaroni/wpcomplete.git"
git remote add origin origin https://github.com/GuidoRiosCiaffaroni/wpcomplete.git
