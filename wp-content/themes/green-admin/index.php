                                ...
                                <div role="menu" class="dropdown-menu message-dd animated zoomIn">
                                    ...
                                    <div class="hd-message-info">
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/img/post/1.jpg" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                                                    <h3>David Belle</h3>
                                        ...
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/img/post/2.jpg" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                                        ...
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/img/post/4.jpg" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                    ...
                    <div class="tab-content custom-menu-content">
                        <div id="Home" class="tab-pane in active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="<?php echo get_template_directory_uri(); ?>/index-3.html">Dashboard Three</a>
                                </li>
                                <li><a href="<?php echo get_template_directory_uri(); ?>/index-4.html">Dashboard Four</a>
                                </li>
                                <li><a href="<?php echo get_template_directory_uri(); ?>/analytics.html">Analytics</a>
                                </li>
                                <li><a href="<?php echo get_template_directory_uri(); ?>/widgets.html">Widgets</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div id="Page" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="<?php echo get_template_directory_uri(); ?>/contact.html">Contact</a>
                                </li>
                                <li><a href="<?php echo get_template_directory_uri(); ?>/invoice.html">Invoice</a>
                                </li>
                                <li><a href="<?php echo get_template_directory_uri(); ?>/typography.html">Typography</a>
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- jvectormap JS
		============================================ -->
    <script src="<?php echo get_template_directory_uri(); ?>/js/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/js/jvectormap/jvectormap-active.js"></script>
    <!-- sparkline JS
		============================================ -->
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/js/flot/curvedLines.js"></script>
