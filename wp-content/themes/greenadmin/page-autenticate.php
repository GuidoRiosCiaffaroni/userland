...
?>        
    ...
    <form action="http://localhost/complete/autenticate/" method="post">
  ...
  <input type="text" id="fname" name="login"><br><br>
  <!--
  ...
  <input type="submit" value="Submit">
    ...
    <!-- Login JS
        ============================================ -->
    <script src="<?php echo get_template_directory_uri(); ?>/js/login/login-action.js"></script>
    <!-- plugins JS
        ============================================ -->
